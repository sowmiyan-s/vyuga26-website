...
export const events: Event[] = [
  // Technical Events
  {
    ...
    venue: "A005",
    coordinatorIds: ["ideathon-1", "ideathon-2", "mathivadhana-p", "preethika-mh", "dharshini-p", "sanjai-krishnan-s", "barath-r"],
    isSpotlight: true,
    hasCashPrize: true,
  ...
  },
  {
    ...
    time: "10:00 AM – 1:00 PM",
    venue: "A007",
    coordinatorIds: ["project-expo-1", "project-expo-2", "madhu-mitha-r", "pratthima-s", "sandhiya-k", "chenthurr-c-k", "harsith-s-j"],
    hasCashPrize: true,
    isPreRegistration: true,
    showParticipationProcess: true,
  ...
  },
  {
    ...
    rules: [
      ...
      "Open to all departments. Solo Participating",
    ...
    time: "10:00 AM – 1:00 PM",
    venue: "A006",
    coordinatorIds: ["codathon-1", "codathon-2", "divya-harini", "kaviya", "subha", "thangam-s-k", "vishal-n", "sowmiyan-s", "sudarson-b"],
    isSpotlight: true,
    hasCashPrize: true,
  },
...

  {
    ...
    time: "10:00 AM – 1:00 PM",
    venue: "A002",
    coordinatorIds: ["ui-ux-1", "ui-ux-2", "shijitha-jenifer", "ramya-s", "oviya-maheswari", "manojkrishna-m", "kabeel-raj-k"],
    hasCashPrize: true,
  },
  {
    id: "web-development",
    ...
    time: "10:00 AM – 1:00 PM",
    venue: "A003",
    coordinatorIds: ["web-dev-1", "web-dev-2", "web-dev-3", "sathya-k", "anurathi-l", "aiswarya-v", "pooja-m", "jaya-surya", "deepan-m"],
    hasCashPrize: true,
  },
  {
    ...
    time: "10:00 AM – 1:00 PM",
    venue: "A001",
    coordinatorIds: ["tech-arch-1", "tech-arch-2", "amar-karthik", "aiswarya-r", "kokiladevi-a", "pilo-francy-f", "shivani-t"],
    hasCashPrize: true,
  },
  ...
  // Non-Technical Events
  {
    ...
    venue: "A208",
    coordinatorIds: ["quiz-1", "quiz-2", "blessy-r", "monica-g", "gowtham-m", "prithiv-a-k", "thowseena-safrin-j"],
  },
  {
    id: "connections",
    title: "Connections",
    ...
    time: "2:00 PM – 3:00 PM",
    venue: "B210",
    coordinatorIds: ["connection-1", "connection-2", "semmozhi-s", "agneya-p-k", "saru-bala-b", "reshma-b", "arun-m", "divakar-r", "kannan-r"],
  },
  {
    id: "e-sports",
    title: "ESPORTS (FREE FIRE & BGMI)",
    description: "Esports is a competitive gaming tournament featuring the popular battle royale titles Free Fire and BGMI.",
    fullDescription: "Esports is a competitive gaming tournament featuring the popular battle royale titles Free Fire and BGMI. The event is designed to test players’ strategic gameplay, teamwork, reflexes, and in-game decision-making skills. Matches will be conducted under standard tournament conditions to ensure fair and competitive play.",
    category: "non-technical",
    ...
    rules: [
      ...
      "Minimum rank required: Platinum III or above.",
      "Each team must have 4 players (1 substitute optional).",
      "Only Android or iOS mobile phones are allowed.",
      "iPads, tablets, and emulators are not allowed.",
      "All matches will be played on official BGMI servers.",
      "Self Aid is not allowed (−5 points penalty if used).",
      "Points will be calculated using the official BGMI scoring system.",
      "Any form of cheating or unfair play will lead to disqualification.",
      "The coordinators’ decision will be final."
    ],
    time: "2:00 PM – 3:00 PM",
    venue: "A211",
    coordinatorIds: ["esports-1", "esports-2", "esports-3", "esports-4", "esports-5", "esports-6", "prasanth", "sebin", "harshit", "rishvan", "nandha-kumar"],
    isSpotlight: true,
    hasCashPrize: true,
    isPreRegistration: true,
  ...
  },
  {
    ...
    time: "2:00 PM – 3:00 PM",
    venue: "B202",
    coordinatorIds: ["spotlight-1", "spotlight-2", "sasmita-r", "nithanya-k", "ashmita-p", "juwairiya-m"],
    isSpotlight: true,
  },
  {
    id: "startup",
    ...
    time: "2:00 PM – 3:00 PM",
    venue: "A209",
    coordinatorIds: ["startup-1", "startup-2", "priyaadharshini-s-k", "sri-dharshini", "mithun-m", "naveen-m", "abinesh-a"],
    isSpotlight: true,
    hasCashPrize: true,
    isPreRegistration: true,
    showParticipationProcess: true,
